...
export default class SingleOrder extends React.Component{
    ...
    this.handleClicktoOrderinfo=this.handleClicktoOrderinfo.bind(this)
    }
   
    componentDidMount(){
    }

    handleClicktoOrderinfo(){
        window.location.href="http://localhost:3000/orderinfo?order_id="+this.state.order_info.order_id
    }
    render(){
        return(
                <div className="singleorder">
                    <div className="order_box">
                        <div className="order_head">
                            ...
                            {this.state.order_info.order_status==3?
                                <React.Fragment>
                                    ...
                                    <div className="order_box_hd_del"><span/>
                                    </div>
                                </React.Fragment>:
                        ...
                        <div className="order_item" onClick={()=>this.handleClicktoOrderinfo()}>
